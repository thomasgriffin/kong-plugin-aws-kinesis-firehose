...
local jsont = require "kong.plugins.aws-kinesis-firehose.jsontransformer"
...
-- constructor
function plugin:new()
  plugin.super.new(self, "aws-kinesis-firehose")
end
...
function plugin:access(config)
  ...
  -- Trigger request
  local host = string.format("firehose.%s.amazonaws.com", config.aws_region)
